...
public class MovieRecommendationsWithJoin {
    public static void main(String[] args) throws Exception {
        ...
        SparkConf conf = new SparkConf().setMaster("local[*]").setAppName("Movies");
        ...
        //STEP-5: movie를 기준으로 moviesRDD 을 그룹화한다.
        ...
        //STEP-6: fatMapToPair함수를 통해 user와 movie마다의 관객수로 K,V값으로 만든다.
        //        K = user
        ...
        //  movieName1 < movieName2를 만족시키는 새로운 RDD를 반환한다.
        JavaPairRDD<String, Tuple2<Tuple3<String,Integer,Integer>,Tuple3<String,Integer,Integer>>>
                //
        ...
        // filter를 통해 user마다의 movie pairs의 중복이 보장된다.
        ...
        //STEP-8: (movie1, movie2)에 대한 combinations
        ...
        // usersRDD 와 transactionsRDD를 union()
